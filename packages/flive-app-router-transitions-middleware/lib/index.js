...
var _constants = require('@sigfox/redux-router/lib/constants');
...
var getDataDependency = function getDataDependency() {
  ...
  return component.WrappedComponent ? getDataDependency(component.WrappedComponent, methodName) : component[methodName];
};
...
var getDataDependencies = function getDataDependencies(components, getState, dispatch, location, params, deferred) {
  ...
  .map(function (fetchData) {
    return fetchData({ getState: getState, dispatch: dispatch, location: location, params: params });
  });
};
...
exports.default = function (_ref) {
  ...
  return function (next) {
    return function (action) {
      if (action.type === _constants.ROUTER_DID_CHANGE) {
        ...
        var promise = new Promise(function (resolve) {
          var doTransition = function doTransition() {
            var promises = getDataDependencies(components, getState, dispatch, location, params, true);
